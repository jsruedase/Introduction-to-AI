...
class RegressionModel(Module):
    ...
    def __init__(self):
        ...
        "*** YOUR CODE HERE ***"
        super().__init__()
        self.w1 = Parameter(torch.randn(1, 8))
        self.b1 = Parameter(zeros(1,8))
        self.w2 = Parameter(torch.randn(8, 8))
        self.b2 = Parameter(zeros(1,8))
        self.w3 = Parameter(torch.randn(8, 1))
